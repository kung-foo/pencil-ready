...
export const WORKSHEET_INFO: Record<WorksheetKind, WorksheetInfo> = {
    ...
    "long-divide": {
        title: "Long division",
        summary:
            "Divide larger numbers step-by-step using the divide–multiply–subtract–bring-down loop.",
        prerequisites: [
    ...
    "mult-drill": {
        ...
        summary:
            "Horizontal facts practice for rapid recall of specific times tables.",
        prerequisites: [
    ...
    "div-drill": {
        ...
        summary:
            "Horizontal facts practice mirroring the multiplication drill, in reverse.",
        prerequisites: [
